...
public class SimulateLiveData {
    ...
    public void simulateEverySecond() {
        ...
        System.out.println("Company: " + data.getCompany()+" "+"Date (raw): " + data.getDate()+" "+"Open: " + data.getOpen()+" "+"Close/Last: " + data.getCloseLast()+" "+"High: " + data.getHigh()+" "+"Low: " + data.getLow()+" "+"Volume: " + data.getVolume());
        System.out.println("======================================");
